...
export default function MemberTransformations() {
  ...
  return (
    <>
      ...
      {transformationData !== null && JSON.stringify(transformationData)}
        ...
        <div className="row">
          <div className="col-md-12 ">
            ...
            <div class="row" data-masonry='{"percentPosition": true }'>
              ...
              <div class="col-sm-6 col-lg-4 mb-4" style={{position: 'absolute', left: '33.3333%', top: 0}}>
                <div class="card p-3">
              ...
              <div class="col-sm-6 col-lg-4 mb-4" style={{position: 'absolute', left: '66.6667%', top: 0}}>
                <div class="card">
                  <svg class="bd-placeholder-img card-img-top" width="100%" height="200" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Image cap" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#868e96"></rect><text x="50%" y="50%" fill="#dee2e6" dy=".3em">Image cap</text></svg>
              ...
              <div class="col-sm-6 col-lg-4 mb-4" style={{position: 'absolute', left: '33.3333%', top: 170}}>
              ...
              <div class="col-sm-6 col-lg-4 mb-4" style={{position: 'absolute', left: '33.3333%', top: 308}}>
              ...
              <div class="col-sm-6 col-lg-4 mb-4" style={{position: 'absolute', left: '0%', top: 362}}>
                <div class="card">
              ...
              <div class="col-sm-6 col-lg-4 mb-4" style={{position: 'absolute', left: '66.6667%', top: 378}}>
              ...
              <div class="col-sm-6 col-lg-4 mb-4" style={{position: 'absolute', left: '33.3333%', top: 486}}>
                <div class="card">
                  <div class="card-body">
                    <h5 class="card-title">Card title</h5>
